...
const QuizEuDora = ({ onComplete }: AdSectionProps) => {
  ...
  const questionnaires: Questionnaire[] = [
    {
      ...
      questions: [
        {
          text: 'Você ja ouvi falar ou usou esse produto?',
          options: ['Sim', 'Não'],
        },
        {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen border bg-gray-100 px-4">
      <div className="bg-white shadow-2xl rounded-xl w-full max-w-lg lg:max-w-xl xl:max-w-2xl mx-auto overflow-hidden">
            ...
            <div className="flex flex-wrap justify-center gap-4 md:gap-4">
              {question.options.map((option, idx) => (
                <button
                  ...
                  className={`py-2 px-5 md:px-4 rounded-md shadow-sm focus:outline-none text-sm lg:text-base ${selectedOptions[index] === option
