    ...
    <header className="fixed top-0 left-0 w-full bg-white shadow-md z-10">
      ...
      <div className="flex items-center justify-between max-w-md mx-auto px-8  py-1">
        ...
        <div className="relative">
          {cartActive && (
            <span
              id="cart-summary-quantity"
              className="absolute top-0 right-0 bg-[#4d057a] text-white text-xs font-normal rounded-full w-5 h-5 flex items-center justify-center -translate-y-1/3 translate-x-1/3"
            >
              1
            </span>
          )}
